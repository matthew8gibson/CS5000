...
public class OutOfBoundException {
    public static void main(String[] args) {
        ...
        int value = -1;
        System.out.println("Debug: " + scan.hasNext() + " line21");
        // setup sentinel
        // Scanner scan = new Scanner(System.in);
        ...
        System.out.println("Debug: " + scan.hasNext() + " line39");
        ...
        while (!isValidInput) {
            ...
            try {
                ...
                System.out.println("Debug: " + scan.hasNext() + " line57");
        ...
        System.out.println("Debug: " + scan.hasNext() + " line77");
